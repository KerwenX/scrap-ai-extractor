...
from .models import ExtractionRequest, TemplateMatch
from .templates import BaseTemplateParser, DayiDiseaseTemplateParser


class TemplateRegistry:
    def __init__(self) -> None:
        self.parsers: list[BaseTemplateParser] = [DayiDiseaseTemplateParser()]
    ...
    def match(
        ...
        for parser in self.parsers:
            match = parser.match(request, soup, page_title)
            if match is None:
                continue
